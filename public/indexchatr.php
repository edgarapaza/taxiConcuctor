...
if(!empty($_SESSION['conductor']))
{
	...
	$_SESSION['myidpedidoRes'] = $idpedidoRes;
	...
	if(isset($_POST['enviar']))
	{
		...
		{	
			...
			$res = $chatboot->GuardarChatReserva($nombre, $mensaje, $idconductor, $idpedidoRes, $idcliente);
	...
	$data = $chatboot->MostrarChatReserva($idconductor, $idpedidoRes, $idcliente);
...
<head>
	...
	<script type="text/javascript">
		...
		function ajax(){
	      	...
	      	req.open('POST', 'datos_chatReserva.php', true);
	      	req.send();
    	}
...
<body onload="ajax();">
	...
	<div id="contenedor">
		<div class="row">
			<a href="menu_d.php?idconductor=<?php echo $idconductor;?>" title="#" class="btn" id="">Regresar al Menu</a>
			<a href="reserva_nocerradas.php?idconductor=<?php echo $idconductor;?>" title="#" class="btn red" id="">Lista de Conversaciones</a>
			Unidad: <?php echo $idconductor;?>
			<br>
			<br>
